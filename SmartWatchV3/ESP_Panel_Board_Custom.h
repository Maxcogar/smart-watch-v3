 ...
 */
    ...
    #define ESP_PANEL_LCD_SPI_IO_CS             (45)
#if !ESP_PANEL_LCD_BUS_SKIP_INIT_HOST
    #define ESP_PANEL_LCD_SPI_IO_SCK            (39)
    #define ESP_PANEL_LCD_SPI_IO_MOSI           (38)
    #define ESP_PANEL_LCD_SPI_IO_MISO           (40)    // -1 if not used
#endif
    #define ESP_PANEL_LCD_SPI_IO_DC             (42)
